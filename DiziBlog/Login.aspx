...
<html lang="en">
<head>
    <title>Dizi Blogu Admin Paneli Giriş </title>
    <!-- Meta tags -->
...
<body>
    <div class="mid-class">
        <div class="art-right-w3ls">
            ...
            <form action="#" method="post" runat="server">
                <div class="main">
                    ...
                    <div class="form-left-to-w3l ">
                        <asp:TextBox ID="TextBox2" TextMode="Password" runat="server" placeholder=" Şifre..."></asp:TextBox>
                        <div class="clear"></div>
                    </div>
                </div>
        ...
        <div class="art-left-w3ls">
            <h1 class="header-w3ls">Dizi & Film Giriş Paneli
            </h1>
        </div>
    </div>
