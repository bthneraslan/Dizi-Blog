<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DiziBlog.Default" %>
                ...
                <div class="comments">
                    ...
                    <asp:Repeater ID="Repeater4" runat="server">
                        <ItemTemplate>
                            <ul>
                                <li><a href="#">
                                    <%# Eval("BLOGBASLIK") %></a> İçin Yapılan Yorum: <a href="#"><%# Eval("YORUMICERIK") %></a>
                                </li>
                            </ul>
                        </ItemTemplate>
                    </asp:Repeater>
