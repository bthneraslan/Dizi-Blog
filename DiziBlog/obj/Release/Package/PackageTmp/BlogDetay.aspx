<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="BlogDetay.aspx.cs" Inherits="DiziBlog.BlogDetay" %>
                ...
                <div class="col-md-8 single-main">
                    <div class="single-grid">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <img src="<%# Eval("BLOGGORSEL") %>" alt="" style="height: 650px; width: 720px; margin-bottom: 20px" />
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            ...
                            <asp:TextBox ID="TextBox3" TextMode="MultiLine"  Rows="5" runat="server" placeholder="Yorumunuz :" required=""></asp:TextBox>
